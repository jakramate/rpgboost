function [w, obj, trainerr, testerr] = gboost_v2(grad_fun, h, x, y, T, ep, lamb, reg_type, xs, ys)
...
for t=1:T 
    ...
    [theta, fv, ~, ~] = minFunc(grad_fun, randn(d+3,1), options, F, h, x, y, lamb, 0, reg_type);  
